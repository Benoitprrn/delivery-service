...
// tels quels (voir apps/web/CLAUDE.md). Seul `content` est adapté à la
// structure de ce projet Next.js.
  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: '#FFFFFF',
        border: '#E7E0D5',
        // Tokens shadcn/ui référencés par app/globals.css (`text-foreground`,
        // `bg-card`, …) mais absents du tailwind.config.ts source du design
        // system — reliés ici aux variables CSS RGB déjà déclarées dans
        // globals.css (`--foreground`, `--card`, …).
